...
class SidekiqSngConsole:
    ...
    def main_menu(self):
        while True:
            ...
            elif choice == '2': self.run_cmd(["./sng", "--tech", "noise", "--chan", "0", "--bw", "1e6", "--rate", "2e6", "--amp", "0.2", "--stream"])
            elif choice == '3': self.run_cmd(["./sng", "--tech", "noise", "--chan", "1", "--bw", "1e6", "--rate", "2e6", "--amp", "0.2", "--stream"])
