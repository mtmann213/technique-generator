...
parser.add_argument(
    '--module', type=str, help='Name of gr module containing file to bind (e.g. fft digital analog)'
)

parser.add_argument(
    '--output_dir', default=tempfile.gettempdir(), help='Output directory of generated bindings'
)
...
parser.add_argument('--include', help='Additional Include Dirs, separated', default=(), nargs='*')
